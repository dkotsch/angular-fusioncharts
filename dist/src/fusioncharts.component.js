...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: FusionChartsComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: i1.FusionChartsService }, { type: i0.KeyValueDiffers }, { type: i0.NgZone }]; }, propDecorators: { placeholder: [{
                type: Input
            }], dataSource: [{
                type: Input
            }], type: [{
